...
public class BottonView {
	...
	private void printBottonView(TreeNode<Integer> root, int d) {
		if(root == null)
			return;
		map.put(d, root.val);
		int l = d-1;
	...
	private void printDiognalView(TreeNode<Integer> root, int d) {
		if(root == null)
			return;
		map.put(d, root.val);
		int l = d;
	...
	public static void main(String[] args) {
		TreeNode<Integer> root = BTreeFactory.getTree();
